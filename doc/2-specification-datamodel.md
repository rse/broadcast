...
| presenterAlert               | A "Moderator" can raise an alert for the presenter.                                                                                                                                                                                                                                                                                                             |
| presenterAlertState          | A "Moderator" can set the __presenterAlert__ active (_raised_), then the __presenterAlert__ is visible for the "Presenter", or he can deactivate (_unraised_) it, then it is not visible to the "Presenter". The "Presenter" also can confirm the alert (_unraised_).  |
...
| isFromModerator   | Is true, if the message is sent by a "Moderator". That will be displayed with a different name ("Moderator") instead of the configured event naming pattern (see ___chatName___ and ___questionsName___ as well as ___chatAllowAnonymous___ and ___questionsAllowAnonymous___ in Entity `Event`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| presenterAnnotation | A "Moderator" can attach a hint to the message for the presenter when he sets the state to _forwarded_. This hint should help the presenter with processing the message in the live event. An example could be: a hint to which live event attendee the question should be directed to (in case no tag exists for this).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| messageText  | A `Message` is related to multiple `MessageText` entities |

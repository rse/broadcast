...
| [Presenter]              | software               | An event "Presenter" is a physical moderator in a recorded video event. He will get forwarded messages from the "Moderator" in order to process them directly on stage in the live event. He marks a processed message after it was presented. Technically, we do not differentiate between moderator and presenter. Depending on the task, the person chooses different views. |
